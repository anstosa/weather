...
BANNED_PATTERN='localhost|127[.]0[.]0[.]1|0[.]0[.]0[.]0|NSAllowsArbitraryLoads|NSExceptionDomains|WKScriptMessageHandler|addScriptMessageHandler|serverTrust|trustAll|api[_-]?key|client[_-]?secret|BEGIN PRIVATE KEY|WEATHER_WIDGET_FIXTURE|m0-fixture-resolution|weather-ui-test|weather-m0-reload-widget|M0 fixture|Maximum density M0|Near cutoff M0|Bedtime M0|Weather route /forecast|about:blank'
