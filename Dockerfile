...
COPY --chown=10002:10002 deploy/scripts/web-server.mjs deploy/scripts/weather-admin-store.mjs deploy/scripts/home-network.mjs deploy/scripts/xweather-tile-cache.mjs deploy/scripts/xweather-usage-budget.mjs deploy/scripts/
USER 10002:10002
