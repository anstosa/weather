...
control_plane_version=9
previous_control_plane_version=8
previous_control_plane_sha256=399bb66688833b73e6a6679db66f0f3c54814c0962b7909f31734190030608e3
...
require_control_plane_compatibility() {
  ...
  # accept only the proven version-eight production handoff
...
verify_previous_image_compatibility() (
  ...
  local live_visibility_migration_count temperature_canary_migration_count rain_collection_migration_count baseline_acl_verified
